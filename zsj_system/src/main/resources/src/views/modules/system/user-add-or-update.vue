<template>
  <el-dialog
    ...
    <el-form-item label="状态：0禁用 1正常" prop="status">
      <el-input v-model="dataForm.status" placeholder="状态：0禁用 1正常"></el-input>
    </el-form-item>
    <el-form-item label="创建时间" prop="createTime">
      <el-input v-model="dataForm.createTime" placeholder="创建时间"></el-input>
    </el-form-item>
    <el-form-item label="创建者id" prop="creatUserId">
      <el-input v-model="dataForm.creatUserId" placeholder="创建者id"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          status: [
            { required: true, message: '状态：0禁用 1正常不能为空', trigger: 'blur' }
          ],
          createTime: [
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.creatUserId = data.user.creatUserId
              }
            })
          }
        })
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'creatUserId': this.dataForm.creatUserId
              })
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.$message({
